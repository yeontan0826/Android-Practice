package com.example.used_trade.mypage
...
import com.example.used_trade.databinding.FragmentMypageBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentMypageBinding.signUpButton.setOnClickListener {
            ...
            auth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(requireActivity()) { task ->
                    if (task.isSuccessful) {
                        Toast.makeText(context, "회원가입에 성공했습니다. 로그인을 해주세요", Toast.LENGTH_SHORT).show()
                    } else {
